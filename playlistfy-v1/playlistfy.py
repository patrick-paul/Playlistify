...
"""
================================================================================
PLAYLISTFY V1 - LEGACY REFERENCE IMPLEMENTATION
================================================================================

File Location: playlistfy-v1/playlistfy.py
Original Name: playlist_downloader.py (renamed and moved January 2025)

Purpose:
    This is the original, fully-functional YouTube Playlist Downloader (v1).
    It serves as the reference implementation for Playlistfy v2.0, which is now
    the modular, package-based version located in ../src/playlistfy/.

Status: LEGACY - DO NOT MODIFY
    This file is preserved for reference purposes only. All new features,
    bug fixes, and improvements should be made to the v2 codebase.

Why This File Exists:
    - Provides a working, single-file fallback option
    - Serves as a feature reference for v2 development
    - Contains the original implementation logic that v2 builds upon
    - Ensures backward compatibility for users who prefer the simple script

Architecture & Features:
    - Single-file monolithic design for easy deployment
    - Automatic dependency installation (yt-dlp, ffmpeg, colorama, tqdm)
    - Cross-platform support (Windows, macOS, Linux)
    - Interactive CLI with colored output and progress bars
    - Single video download with quality selection
    - Full playlist download (sequential or parallel)
    - Video range selection (e.g., download videos 1-10)
    - Browser cookie authentication to bypass bot detection
    - Comprehensive error handling with automatic retry logic
    - Smart ffmpeg detection and installation assistance

What V2 Inherits from This File:
    - Core download logic and yt-dlp command structure
    - Dependency checking and installation patterns
    - Progress tracking and user interaction patterns
    - Error handling strategies and retry mechanisms
    - Platform detection and OS-specific installation methods
    - Cookie-based authentication for bot detection bypass

What V2 Adds Beyond This File:
    - Smooth UI with Rich library (spinner → progress bar transitions)
    - LiveDisplay manager for flicker-free updates
    - Scroll-in content reveals
    - Cross-platform safe character handling
    - Enhanced progress visualization
    - Automatic Rich dependency management
...
How to Run This File:
    ...
    From within the playlistfy-v1 folder:
        python playlistfy.py

    The script will:
    1. Check and install Python dependencies (colorama, tqdm, yt-dlp)
    2. Verify ffmpeg installation (offer to install if missing)
    3. Present an interactive menu for downloads
    4. Guide you through the download process with progress tracking

V1 vs V2 Differences:
    V1 (This File - playlistfy-v1/playlistfy.py):
    - Single monolithic file (~1160 lines)
    - All code in global scope or single-level functions
    - Direct user interaction in main()
    - Inline configuration and constants
    - Basic tqdm progress bars

    V2 (src/playlistfy/):
    - Modular package architecture with clear separation of concerns
    - Core, Services, UI, Utils, and Config layers
    - Settings persistence and "don't ask again" system
    - Enhanced UX with smooth Rich-powered UI transitions
    - Spinners, better menus, playlist folders
    - Clean filenames matching video titles
    - Session management and statistics tracking
    - Hierarchical configuration system
    - LiveDisplay manager for professional terminal output

Documentation Updated: January 2025
Generated by: AI assistant (Claude) as documentation only
Project Repository: https://github.com/patrick-paul/Playlistfy
